...
- **Source whitelist (priority):** tuning books (Banish ×2; Bell *Maximum Boost*; Cramer/Hoffmann; Heywood — full list given to Syed 2026-07-03, drop into `data/raw/pdfs/books/`); FSMs (2005 Forester + JDM Legacy GT for the EJ20X); the RomRaider wiki/definitions; forums — **LIVE: legacygt, speeduino, msextra, romraider.com (one generic phpBB engine); BUILT-BUT-GATED: NASIOC (hard Cloudflare)**; cross-platform defs (**tunerstudio_ini**, 55 docs) + OBD-II PIDs (J1979); wideband manuals (AEM 30-0300 ingested); data artifacts (posted RomRaider logs, before/after ROM diffs — *binary attachments need Syed's forum accounts → `data/raw/roms/`*).
